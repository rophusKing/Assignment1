...
window.onload = function() {
    ...
    html += "<div id='_name'>";
    html += "<div id='_firstname'>Fabian</div>"; // replace Harry with your firstname
    html += "<div id='_lastname'>King</div>"; // replace Bentley with your lastname
    html += "<div id='_shortname'>Fabian_King</div>"; // replace bentley_harr with your shortname	
    html += "</div>";
    ...
    html += "<span id='_semester'>Bentley University Fall 2022</span>";
